...
CTH3DS_BUILD_PROFILE="${CTH3DS_BUILD_PROFILE:-loose}"
case "${CTH3DS_BUILD_PROFILE}" in
  loose|resource-experiment) ;;
  *) printf '[cth3ds] error: invalid build profile: %s\n' "${CTH3DS_BUILD_PROFILE}" >&2; exit 2 ;;
esac
export CTH3DS_BUILD_PROFILE
CTH3DS_PROFILE_SUFFIX=""
...
CTH3DS_DIST_DIR="${CTH3DS_DIST_DIR:-${CTH3DS_ROOT}/dist${CTH3DS_PROFILE_SUFFIX}}"
