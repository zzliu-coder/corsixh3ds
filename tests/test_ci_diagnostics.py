...
def make_fresh_sources(root: Path):
  ...
  },
  {
    ...
    rehash = {"manifest_sha256": "5" * 64, "sha256sums_sha256": "6" * 64, "checked": []}
    r4_evidence[0].update(review_session_id=sid, verified_invocation_sha256=invocation,
                          ...
                          candidate_transport={"head": FRESH_HEAD})
    ...
    for profile in ("sanitized", "non_sanitized"):
        for index in range(1, 21):
            ...
            journal.append(invocation_row(f"r4.n90_final_audit.h2_{profile}_{index:02d}", ["r4.n81_cycle_acceptance"]))
