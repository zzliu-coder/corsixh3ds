...
## 最新决定：30FPS作为参考，既定优化继续推进

2026-09-09用户调整目标：30FPS仅作为观察参考，不再是必达、单独FAIL条件或交付门槛。
现有五框架优化与已排工作全部保留，按实际收益和稳定性逐项验收；原版帧率还原声明保持NOT_PROVEN。
...
两轮都低于30FPS参考值及名义实时推进能力。工作量未完全锁同，不能凭两次小差异
...
同窗观察模拟时钟。最终收口看已排优化的实测结果、正确模拟、存档连续性、容量与长时
稳定性；无收益或高风险试验保留证据和回退，不声称所有理论优化已经穷尽。
